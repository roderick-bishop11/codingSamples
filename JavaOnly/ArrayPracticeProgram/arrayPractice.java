 ...
 *  		3) I should probably use another class to clean up this one, there is A LOT going on in this one. 
...
public class arrayPractice {
	...
	public static List<Integer> findInt(int[] a, int target) {
		...
		for(int i = 0; i<a.length;i++) {
			...
			return(nums.isEmpty())? nums:Collections.EMPTY_LIST; //fancy little boolean expression that I learned at FMU using the "?" operator
